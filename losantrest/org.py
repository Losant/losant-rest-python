...
class Org(object):
    ...
    def patch(self, **kwargs):
        ...
        Parameters:
        *  {string} orgId - ID associated with the organization
        *  {dict} organization - Object containing new organization properties (https://api.losant.com/#/definitions/orgPatch)
        *  {boolean} _actions - Return resource actions in response
        *  {boolean} _links - Return resource link in response
        *  {boolean} _embedded - Return embedded resources in response
    ...
    def invite_member(self, **kwargs):
        ...
        Parameters:
        *  {string} orgId - ID associated with the organization
        *  {dict} invite - Object containing new invite info (https://api.losant.com/#/definitions/orgInvitePost)
        *  {boolean} _actions - Return resource actions in response
        *  {boolean} _links - Return resource link in response
        *  {boolean} _embedded - Return embedded resources in response
    ...
    def modify_member(self, **kwargs):
        ...
        Parameters:
        *  {string} orgId - ID associated with the organization
        *  {dict} member - Object containing new member pair (https://api.losant.com/#/definitions/orgMemberPatch)
        *  {boolean} _actions - Return resource actions in response
        *  {boolean} _links - Return resource link in response
        *  {boolean} _embedded - Return embedded resources in response
