...
class Data(object):
    ...
    def time_series_query(self, **kwargs):
        ...
        *  {dict} query - The query parameters (https://api.losant.com/#/definitions/timeSeriesQuery)
    ...
    def last_value_query(self, **kwargs):
        ...
        Parameters:
        *  {string} applicationId - ID associated with the application
        *  {dict} query - The query parameters (https://api.losant.com/#/definitions/lastValueQuery)
        *  {boolean} _actions - Return resource actions in response
        *  {boolean} _links - Return resource link in response
        *  {boolean} _embedded - Return embedded resources in response
