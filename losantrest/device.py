...
class Device(object):
    ...
    def patch(self, **kwargs):
        ...
        *  {string} applicationId - ID associated with the application
        *  {string} deviceId - ID associated with the device
        *  {dict} device - Object containing new properties of the device (https://api.losant.com/#/definitions/devicePatch)
        *  {boolean} _actions - Return resource actions in response
        *  {boolean} _links - Return resource link in response
        *  {boolean} _embedded - Return embedded resources in response
    ...
    def send_state(self, **kwargs):
        ...
        *  {string} applicationId - ID associated with the application
        *  {string} deviceId - ID associated with the device
        *  {dict} deviceState - Object containing the current state of the device (https://api.losant.com/#/definitions/deviceState)
        *  {boolean} _actions - Return resource actions in response
        *  {boolean} _links - Return resource link in response
        *  {boolean} _embedded - Return embedded resources in response
    ...
    def send_command(self, **kwargs):
        ...
        *  {string} applicationId - ID associated with the application
        *  {string} deviceId - ID associated with the device
        *  {dict} deviceCommand - Command to send to the device (https://api.losant.com/#/definitions/deviceCommand)
        *  {boolean} _actions - Return resource actions in response
        *  {boolean} _links - Return resource link in response
        *  {boolean} _embedded - Return embedded resources in response
